      ...
      dap.configurations.cpp = {
        {
          ...
          request = "launch",
          program = function()
            local function get_debug_program()
              local root_dir = vim.fn.getcwd()
              local debug_dir = root_dir .. "/debug"
              local file_name = vim.fn.expand "%:t:r"
              return debug_dir .. "/" .. file_name
            end

            local debug_program = get_debug_program()

            -- Ensure debug directory exists
            vim.fn.mkdir(vim.fn.fnamemodify(debug_program, ":h"), "p")

            -- Compile the program
            local compile_cmd = string.format("clang++ -g %s -o %s", vim.fn.expand "%:p", debug_program)
